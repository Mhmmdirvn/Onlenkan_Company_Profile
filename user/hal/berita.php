    ...
    <section class="py-5">
        <div class="container blog-bg-sec">
            <div class="row text-center">
                <div class="col">
                    <h3 class="title-style mb-2 text-center py-5 " >Berita Terbaru</h3>
                </div>
            </div>
            <div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center">
                ...
                ?>
                      <div class="col-lg-6 col-md-6 grids5-info border-5 box-shadow py-3">
                        <div class="card h-100">
                            <a href="#"><img src="../gambar/<?= $r['gambar'] ?>" alt="" class="card-img-top img-fluid" style="height: 400px; object-fit: cover; border-bottom: 0.5px solid grey;"></a>
                            <div class="card-body">
                                <h5 class="card-title " id="Dark-text"><span class="fa fa-date"></span><?= $r['tanggal'] ?></h5>
                                <h4 class="card-text "><a href="#blog" style="color: black; font-weight: bold   ;"><?= $r['judul_berita'] ?></a></h4>
                            </div>
                        </div>
                    </div>
