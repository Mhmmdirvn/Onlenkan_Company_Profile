            ...
            <nav class="navbar navbar-expand-lg navbar-light navbar-scroll" id="navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav mx-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href=".?hal=agenda">Agenda</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="hero-content">
                        <div class="w3l-breadcrumb py-lg-5">
                            <div class="container pt-4 pb-sm-4">
                                <h4 class="inner-text-title font-weight-bold pt-sm-5 pt-4">Agenda</h4>
                                <ul class="breadcrumbs-custom-path">
                                    <li><a href=".">Beranda</a></li>
                                    <li class="active"><i class="fas fa-angle-right mx-2"></i>Agenda</li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row text-center">
                <div class="col">
                    <h3 class="title-style mb-2 text-center py-5 ">Agenda</h3>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 py-2">
                        <div class="card text-center">
                            <div class="card-header">
                                <p style="font-weight: bold; color: black;"><?= $r['judul_agenda'] ?></p>
                            </div>
                            <div class="card-body">
                                <p class="card-text" style="color: black;"><?= $r['content_agenda'] ?></p>
                            </div>
                            <div class="card-footer text-body-secondary">
                                <a href="#" style="color: black;"><?= $r['tanggal'] ?></a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
