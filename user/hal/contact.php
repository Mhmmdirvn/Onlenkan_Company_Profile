            ...
            <nav class="navbar navbar-expand-lg navbar-light navbar-scroll" id="navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav mx-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href=".?hal=contact">Contact Us</a>
                        </li>
                    </ul>
        ...
        <div class="container py-md-5 py-4">
                ...
                <div class="contact-infos">
                    <div class="single-contact-infos">
                        ...
                        <div class="text-box">
                            ...
                            <p>Jl. Dr.Sutomo No.141, Mangunharjo, Kec.Mayangan, Kota Probolinggo, Jawa Timur 67211</p>
                        </div>
                    </div>
                    <div class="single-contact-infos">
                        ...
                        <div class="text-box">
                            ...
                            <p class=""> Monday – Friday : 8AM - 3PM</p>
                        </div>
                    </div>
                    <div class="single-contact-infos">
                        ...
                        <div class="text-box">
                            ...
                            <p class=""><a href="tel:+1(21) 234 4567">+6287777000032</a></p>
                            <p class=""> <a href="mailto:info@support.com">marketing@onlenkan.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mt-5 pt-md-5">
                <div class="col-lg-6 map order-lg-1 order-2">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d988.3457916542582!2d113.21746557593637!3d-7.749120731960012!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7ad9d4bacb9cb%3A0x17220e29c756119b!2sOnlenkan.com%20-%20Jasa%20Pembuatan%20Website%20%26%20Aplikasi%20Probolinggo!5e0!3m2!1sen!2sid!4v1683708129530!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="col-lg-6 form-inner-cont order-lg-2 order-1 mb-lg-0 mb-5 ps-lg-4">
                    <form action="" method="post">
                        ...
                        <div class="mt-4 mb-0 form-group">
                            <div class="d-grid">
                                <input type="submit" value="Kirim" name="simpan" style="display: inline-block;
                                                                                        font-weight: 400;
                                                                                        line-height: 1.5;
                                                                                        color: #212529;
                                                                                        text-align: center;
                        ...
                        if (@$_POST['simpan']) {
                            ...
                            $pesan = $_POST['pesan'];
                            $tgl = date("Y-m-d");
                            mysqli_query($koneksi, "INSERT INTO tb_pesan(email,pesan,tanggal)VALUES('$email','$pesan','$tgl')");
                            echo "<script>alert('Data berhasil di simpan');location='.?hal=contact'</script>";
                        }
                        ?>
                    </form>
                </div>
